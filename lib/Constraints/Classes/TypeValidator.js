...
class TypeValidator extends Validator {
    ...
    configuring() {
        this.types = [
            'array', 'bool', 'boolean', 'float', 'double', 'int', 'integer', 'null', 'numeric', 'object', 'scalar', 'string', 'callable', 'long', 'real',
            'resource', 'alnum', 'alpha', 'cntrl', 'digit', 'graph', 'lower', 'print', 'punct', 'space', 'upper', 'xdigit' /* todo */
        ];
