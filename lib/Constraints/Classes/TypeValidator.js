...
class TypeValidator extends Validator {
    ...
    configuring() {
        this.types = [
            'array', 'bool', 'boolean', 'float', 'double', 'int', 'integer', 'null', 'numeric', 'object', 'scalar', 'string', 'callable',
            'real', 'resource', 'long', 'alnum', 'alpha', 'cntrl', 'digit', 'graph', 'lower', 'print', 'punct', 'space', 'upper', 'xdigit' /* todo */
        ];
