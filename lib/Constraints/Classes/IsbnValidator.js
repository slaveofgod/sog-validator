...
class IsbnValidator extends Validator {
    constructor() {
        ...
        var isbn10Message = arguments[0]['isbn10Message'];
        var isbn13Message = arguments[0]['isbn13Message'];
        var bothIsbnMessage = arguments[0]['bothIsbnMessage'];
