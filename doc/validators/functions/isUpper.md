# isUpper
Validates that a value is `upper` data type. Check for uppercase character(s). Checks if all of the characters in the provided string are uppercase characters.
