# isDigit
Validates that a value is `digit` data type. Check for numeric character(s). Checks if all of the characters in the provided string are numerical.
