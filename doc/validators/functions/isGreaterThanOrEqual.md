...
Validates that a value is greater than or equal to another value, defined in the options. To force that a value is greater than another value, see [isGreaterThan][is-greaterthan-url].
...
if(_v.func.isGreaterThanOrEqual(data, {'value': 10})){
    // Some code ...
}
```
