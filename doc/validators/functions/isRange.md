...
if(_v.func.isRange(data, {'min': 1, 'max': 100})){
    // Some code ...
}

// Or

var data = new Date(2015, 0, 1, 0, 0, 0, 0);

if(_v.func.isRange(data, {'min': new Date(2015, 0, 1, 0, 0, 0, 0), 'max': new Date(2017, 0, 1, 0, 0, 0, 0)})){
    // Some code ...
}
```
