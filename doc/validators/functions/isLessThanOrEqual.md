# isLessThanOrEqual
Validates that a value is less than or equal to another value, defined in the options. To force that a value is less than another value, see [isLessThan][is-lessthan-url].
...
if(_v.func.isLessThanOrEqual(data, {'value': 10})){
    // Some code ...
}
```
