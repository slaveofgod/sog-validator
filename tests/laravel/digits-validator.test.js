...
describe('digits', () => {
    ...
    describe('Is Invalid', () => {
        test('String "abcd efgh ijklmn" ["length":10]', () => {
            expect(abv.isValidWithErrorMessage("abcd efgh ijklmn", 'digits:{"length":10}')).toBe("The value must be undefined digits.");
        });

        test('String "abcd efgh ijklmn" ["length":15]', () => {
            expect(abv.isValidWithErrorMessage("abcd efgh ijklmn", 'digits:{"length":15}')).toBe("The value must be undefined digits.");
        });

        test('String " abcd efgh ijklmnopq " ["length":5]', () => {
            expect(abv.isValidWithErrorMessage(" abcd efgh ijklmnopq ", 'digits:{"length":5}')).toBe("The value must be undefined digits.");
        });

        test('String " abcd efghi " ["length":10]', () => {
            expect(abv.isValidWithErrorMessage(" abcd efghi ", 'digits:{"length":10}')).toBe("The value must be undefined digits.");
        });

        test('String " abcd efgh ijklmnopq " ["length":10]', () => {
            expect(abv.isValidWithErrorMessage(" abcd efgh ijklmnopq ", 'digits:{"length":10}')).toBe("The value must be undefined digits.");
        });
        ...
        test('String "abcd" [min:5,max:10]', () => {
            expect(abv.isValidWithErrorMessage("abcd", 'digits:{"length":5}')).toBe("The value must be undefined digits.");
        });
