...
describe('active_url', () => {
    describe('Is Valid', () => {
        ...
        test('Null', () => {
            expect(abv.isValidWithErrorMessage(null, 'active_url')).toBe(toBe);
        });

        test('Empty string will not validate', () => {
            expect(abv.isValidWithErrorMessage('', 'active_url')).toBe(toBe);
        });

        test('https://www.google.com/', () => {
            expect(abv.isValidWithErrorMessage('https://www.google.com/', 'active_url')).toBe(toBe);
        });

        test('http://www.google.com/', () => {
            expect(abv.isValidWithErrorMessage('http://www.google.com/', 'active-url')).toBe(toBe);
        });
        ...
        test('ftp://www.google.com/', () => {
            expect(abv.isValidWithErrorMessage('ftp://www.google.com/', 'active_url')).toBe(toBe);
        });
    });

    describe('Is Invalid', () => {
        test('//www.google.com/', () => {
            expect(abv.isValidWithErrorMessage('//www.google.com/', 'active_url')).toBe("The value is not a valid URL.");
        });

        test('Lorem Ipsum', () => {
            expect(abv.isValidWithErrorMessage('Lorem Ipsum', 'active_url')).toBe("The value is not a valid URL.");
        });
    });
});