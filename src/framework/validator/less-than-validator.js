Object.assign(abv, function () {
     ...
     * @classdesc Validates that a value is less than another value, defined in the options.
     ...
     * <p>Default: "<code class="notranslate">This value should be less than %%compared_value%%.</code>"</p>
