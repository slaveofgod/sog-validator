Object.assign(sogv, function () {
    ...
    TimeValidator.prototype = Object.create(sogv.BaseValidator.prototype);
    ...
    Object.assign(TimeValidator.prototype, {
         ...
         */
        __validate: function () {
            if (this.data !== this.__moment(new Date('2020-01-01T' + this.data), this.format).format(this.format)) {
