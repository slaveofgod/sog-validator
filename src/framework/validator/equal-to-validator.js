Object.assign(abv, function () {
     ...
     * This constraint compares using ==, so 3 and "3" are considered equal. Use abv.IdenticalTo to compare with ===.
     ...
     * Defaults to "This value should be equal to %%compared_value%%."
