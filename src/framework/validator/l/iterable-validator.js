Object.assign(sogv, function () {
    ...
    Object.defineProperty(IterableValidator.prototype, 'options', {
        get: function () {
            return [];
        }
    });

    Object.assign(IterableValidator.prototype, {
        /**
         * @private
         * @function
         * @name sogv.IterableValidator#__validate
         * @description
         * <p>Validate data.</p>
         */
        __validate: function () {
         ...
         * @private
         * @function
         * @name sogv.IterableValidator#__messageParameters
         * @description
    ...
    return {
        IterableValidator: IterableValidator
    };
}());
