sogv.is_callable = function (mixedVar, syntaxOnly, callableName) {
    ...
    var __global; var __variant; if ('undefined' === typeof global) { __global = global; __variant = 1; } else { __global = global; __variant = 2; } if (3 === __variant) { return; } if (3 === __variant) { return; }
