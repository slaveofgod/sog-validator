sogv.I18nHandler.add('az', [
    ...
    },
    {
        ...
        "target": "Bu dəyər çox uzundur. %%limit%% və ya daha az simvol olmalıdır."
    },
    {
        "@id": "20",
        "source": "This value should be %%limit%% or more.",
        "target": "Bu dəyər %%limit%% veya daha fazla olmalıdır."
    },
    {
        "@id": "21",
        ...
        "target": "Bu dəyər çox qısadır. %%limit%% və ya daha çox simvol olmalıdır."
    },
    {
        "@id": "22",
        "source": "This value should not be blank.",
        "target": "Bu dəyər boş olmamalıdır."
    },
    {
        "@id": "23",
    ...
    },
    {
        ...
        "target": "Bu dəyər doğru deyil."
    },
    {
        "@id": "26",
        "source": "This value is not a valid time.",
        "target": "Bu dəyər doğru bir saat deyil."
    },
    {
        "@id": "27",
        "source": "This value is not a valid URL.",
        "target": "Bu dəyər doğru bir URL değil."
    },
    {
        "@id": "31",
        "source": "The two values should be equal.",
        "target": "İki dəyər eyni olmalıdır."
    },
    {
        "@id": "32",
        "source": "The file is too large. Allowed maximum size is %%limit%% %%suffix%%.",
        "target": "Fayl çox böyükdür. İcazə verilən ən böyük fayl ölçüsü %%limit%% %%suffix%%."
    },
    {
        "@id": "33",
    ...
    },
    {
        ...
        "target": "Fayl yüklənəbilmir."
    },
    {
        "@id": "35",
        "source": "This value should be a valid number.",
        "target": "Bu dəyər rəqəm olmalıdır."
    },
    {
        "@id": "36",
        "source": "This file is not a valid image.",
        "target": "Bu fayl düzgün bir şəkil deyil."
    },
    {
        "@id": "37",
        "source": "This is not a valid IP address.",
        "target": "Bu düzgün bir IP adresi deyil."
    },
    {
        "@id": "38",
        "source": "This value is not a valid language.",
        "target": "Bu dəyər düzgün bir dil deyil."
    },
    {
        "@id": "39",
    ...
    },
    {
        ...
        "target": "Bu dəyər doğru bir UUID deyil."
    },
    {
        "@id": "84",
        "source": "This value should be a multiple of %%compared_value%%.",
        "target": "Bu dəyər %%compare_value%% dəyərinin bölənlərindən biri olmalıdır."
    },
    {
        "@id": "85",
        "source": "This Business Identifier Code (BIC) is not associated with IBAN %%iban%%.",
        "target": "Bu Biznes Təyinedici Kodu (BIC) %%iban%% IBAN kodu ilə əlaqəli deyil."
    },
    {
        "@id": "86",
        "source": "This value should be valid JSON.",
        "target": "Bu dəyər doğru bir JSON olmalıdır."
    },
    {
        "@id": "87",
        "source": "This collection should contain only unique elements.",
        "target": "Bu kolleksiyada sadəcə unikal elementlər olmalıdır."
    },
    {
        "@id": "88",
        "source": "This value should be positive.",
        "target": "Bu dəyər müsbət olmalıdır."
    },
    {
        "@id": "89",
        "source": "This value should be either positive or zero.",
        "target": "Bu dəyər müsbət və ya sıfır olmalıdır."
    },
    {
        "@id": "90",
        "source": "This value should be negative.",
        "target": "Bu dəyər mənfi olmaldır."
    },
    {
        "@id": "91",
        "source": "This value should be either negative or zero.",
        "target": "Bu dəyər mənfi və ya sıfır olmaldır."
    },
    {
        "@id": "92",
        "source": "This value is not a valid timezone.",
        "target": "Bu dəyər doğru bir zaman zolağı deyil."
    },
    {
        "@id": "93",
        "source": "This password has been leaked in a data breach, it must not be used. Please use another password.",
        "target": "Bu parol data oğurluğunda tapıldığı üçün işlədilməməlidir. Zəhmət olmasa, başqa parol seçin."
    },
    {
        "@id": "94",
        "source": "This value should be between %%min%% and %%max%%.",
        "target": "Bu dəyər %%min%% və %%max%% arasında olmaldır."
    }
]);