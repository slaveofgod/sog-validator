sogv.I18nHandler.add('tr', [
    ...
    },
    {
        ...
        "target": "Bu değer çok uzun. %%limit%% karakter veya daha az olmalıdır."
    },
    {
        "@id": "20",
        "source": "This value should be %%limit%% or more.",
        "target": "Bu değer %%limit%% veya daha fazla olmalıdır."
    },
    {
        "@id": "21",
        ...
        "target": "Bu değer çok kısa. %%limit%% karakter veya daha fazla olmaldır."
    },
    {
        "@id": "22",
        "source": "This value should not be blank.",
        "target": "Bu değer boş bırakılmamalıdır."
    },
    {
        "@id": "23",
    ...
    },
    {
        ...
        "target": "Bu değer boş bırakılmalıdır."
    },
    {
        "@id": "25",
        "source": "This value is not valid.",
        "target": "Bu değer geçerli değil."
    },
    {
        "@id": "26",
        "source": "This value is not a valid time.",
        "target": "Bu değer doğru bir saat değil."
    },
    {
        "@id": "27",
        "source": "This value is not a valid URL.",
        "target": "Bu değer doğru bir URL değil."
    },
    {
        "@id": "31",
        "source": "The two values should be equal.",
        "target": "İki değer eşit olmalıdır."
    },
    {
        "@id": "32",
        "source": "The file is too large. Allowed maximum size is %%limit%% %%suffix%%.",
        "target": "Dosya çok büyük. İzin verilen en büyük dosya boyutu %%limit%% %%suffix%%."
    },
    {
        "@id": "33",
    ...
    },
    {
        ...
        "target": "Bu değer %%compared_value_type%% %%compared_value%% ile aynı olmamalıdır."
    },
    {
        "@id": "73",
        "source": "The image ratio is too big (%%ratio%%). Allowed maximum ratio is %%max_ratio%%.",
        "target": "Resim oranı çok büyük (%%ratio%%). İzin verilen maksimum oran: %%max_ratio%%."
    },
    {
        "@id": "74",
        "source": "The image ratio is too small (%%ratio%%). Minimum ratio expected is %%min_ratio%%.",
        "target": "Resim oranı çok ufak (%%ratio%%). Beklenen minimum oran %%min_ratio%%."
    },
    {
        "@id": "75",
        "source": "The image is square (%%width%%x%%height%%px). Square images are not allowed.",
        "target": "Resim karesi (%%width%%x%%height%%px). Kare resimlerine izin verilmiyor."
    },
    {
        "@id": "76",
        "source": "The image is landscape oriented (%%width%%x%%height%%px). Landscape oriented images are not allowed.",
        "target": "Resim manzara odaklı (%%width%%x%%height%%px). Manzara odaklı resimlere izin verilmiyor."
    },
    {
        "@id": "77",
        "source": "The image is portrait oriented (%%width%%x%%height%%px). Portrait oriented images are not allowed.",
        "target": "Resim portre odaklı (%%width%%x%%height%%px). Portre odaklı resimlere izin verilmiyor."
    },
    {
        "@id": "78",
        "source": "An empty file is not allowed.",
        "target": "Boş bir dosyaya izin verilmiyor."
    },
    {
        "@id": "79",
        "source": "The host could not be resolved.",
        "target": "Sunucu çözülemedi."
    },
    {
        "@id": "80",
        "source": "This value does not match the expected %%charset%% charset.",
        "target": "Bu değer beklenen %%charset%% karakter kümesiyle eşleşmiyor."
    },
    {
        "@id": "81",
        "source": "This is not a valid Business Identifier Code (BIC).",
        "target": "Bu geçerli bir İşletme Tanımlayıcı Kodu (BIC) değildir."
    },
    {
        "@id": "82",
        "source": "Error",
    ...
    },
    {
        ...
        "target": "Bu geçerli bir UUID değildir."
    },
    {
        "@id": "84",
        "source": "This value should be a multiple of %%compared_value%%.",
        "target": "Bu değer %%compare_value%% değerinin katlarından biri olmalıdır."
    },
    {
        "@id": "85",
        "source": "This Business Identifier Code (BIC) is not associated with IBAN %%iban%%.",
        "target": "Bu İşletme Tanımlayıcı Kodu (BIC), IBAN %%iban%% ile ilişkili değildir."
    }
]);