abv.I18nHandler.add('th', [
    ...
    },
    {
        ...
        "target": "ไฟล์ไม่อยู่ในสถานะที่สามารถอ่านได้"
    },
    {
        "@id": "16",
        "source": "The file is too large (%%size%% %%suffix%%). Allowed maximum size is %%limit%% %%suffix%%.",
        "target": "ไฟล์ใหญ่เกิน (%%size%% %%suffix%%) อนุญาตให้ใหญ่ที่สุดได้ไม่เกิน %%limit%% %%suffix%%"
    },
    {
        "@id": "17",
        "source": "The mime type of the file is invalid (%%type%%). Allowed mime types are %%types%%.",
        "target": "Mime type ของไฟล์ไม่ถูกต้อง (%%type%%) Mime types ที่อนุญาตคือ %%types%%"
    },
    {
        "@id": "18",
        "source": "This value should be %%limit%% or less.",
        "target": "ค่านี้ควรจะเป็น %%limit%% หรือน้อยกว่านั้น"
    },
    {
        "@id": "19",
        ...
        "target": "ค่านี้ยาวเกินไป ควรจะมีแค่ %%limit%% ตัวอักษรหรือน้อยกว่านั้น"
    },
    {
        "@id": "20",
        "source": "This value should be %%limit%% or more.",
        "target": "ค่านี้ควรจะมี %%limit%% หรือมากกว่านั้น"
    },
    {
        "@id": "21",
        ...
        "target": "ค่านี้สั้นเกินไป ควรจะมี %%limit%% ตัวอักษรหรือมากกว่านั้น"
    },
    {
        "@id": "22",
        "source": "This value should not be blank.",
        "target": "ค่านี้ไม่ควรเป็นค่าว่าง"
    },
    {
        "@id": "23",
        "source": "This value should not be null.",
        "target": "ค่านี้ไม่ควรเป็นค่า null"
    },
    {
        "@id": "24",
        "source": "This value should be null.",
        "target": "ค่านี้ควรเป็นค่า null"
    },
    {
        "@id": "25",
        "source": "This value is not valid.",
        "target": "ค่านี้ไม่ถูกต้อง"
    },
    {
        "@id": "26",
        "source": "This value is not a valid time.",
        "target": "ค่าของเวลาไม่ถูกต้อง"
    },
    {
        "@id": "27",
        "source": "This value is not a valid URL.",
        "target": "ค่าของ URL ไม่ถูกต้อง"
    },
    {
        "@id": "31",
        "source": "The two values should be equal.",
        "target": "ค่าทั้งสองค่าควรจะเหมือนกัน"
    },
    {
        "@id": "32",
        "source": "The file is too large. Allowed maximum size is %%limit%% %%suffix%%.",
        "target": "ขนาดไฟล์ใหญ่เกินไป อนุญาตให้ไฟล์ขนาดใหญ่ได้ไม่เกิน %%limit%% %%suffix%%"
    },
    {
        "@id": "33",
        "source": "The file is too large.",
        "target": "ขนาดไฟล์ใหญ่เกินไป"
    },
    {
        "@id": "34",
        "source": "The file could not be uploaded.",
        "target": "ไม่สามารถอัปโหลดไฟล์ได้"
    },
    {
        "@id": "35",
