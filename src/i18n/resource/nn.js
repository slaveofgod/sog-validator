abv.I18nResource['nn'] = [
    ...
    },
    {
        ...
        "target": "Verdien er ikkje ein gyldig dato."
    },
    {
        "@id": "12",
        "source": "This value is not a valid datetime.",
        "target": "Verdien er ikkje ein gyldig dato og tid."
    },
    {
        "@id": "13",
        "source": "This value is not a valid email address.",
        "target": "Verdien er ikkje ei gyldig e-postadresse."
    },
    {
        "@id": "14",
        "source": "The file could not be found.",
        "target": "Fila er ikkje funnen."
    },
    {
        "@id": "15",
        "source": "The file is not readable.",
        "target": "Fila kan ikkje lesast."
    },
    {
        "@id": "16",
        "source": "The file is too large (%%size%% %%suffix%%). Allowed maximum size is %%limit%% %%suffix%%.",
        "target": "Fila er for stor (%%size%% %%suffix%%). Maksimal storleik er %%limit%% %%suffix%%."
    },
    {
        "@id": "17",
        "source": "The mime type of the file is invalid (%%type%%). Allowed mime types are %%types%%.",
        "target": "Mime-typen av fila er ugyldig (%%type%%). Tillatne mime-typar er %%types%%."
    },
    {
        "@id": "18",
        "source": "This value should be %%limit%% or less.",
        "target": "Verdien må vere %%limit%% eller mindre."
    },
    {
        "@id": "19",
        ...
        "target": "Verdien er for lang. Den må vere %%limit%% bokstavar eller mindre."
    },
    {
        "@id": "20",
        "source": "This value should be %%limit%% or more.",
        "target": "Verdien må vere %%limit%% eller meir."
    },
    {
        "@id": "21",
        ...
        "target": "Verdien er for kort. Den må ha %%limit%% teikn eller fleire."
    },
    {
        "@id": "22",
        "source": "This value should not be blank.",
        "target": "Verdien kan ikkje vere blank."
    },
    {
        "@id": "23",
        "source": "This value should not be null.",
        "target": "Verdien kan ikkje vere tom (null)."
    },
    {
        "@id": "24",
        "source": "This value should be null.",
        "target": "Verdien må vere tom (null)."
    },
    {
        "@id": "25",
        "source": "This value is not valid.",
        "target": "Verdien er ikkje gyldig."
    },
    {
        "@id": "26",
        "source": "This value is not a valid time.",
        "target": "Verdien er ikkje ei gyldig tidseining."
    },
    {
        "@id": "27",
        "source": "This value is not a valid URL.",
        "target": "Verdien er ikkje ein gyldig URL."
    },
    {
        "@id": "31",
        "source": "The two values should be equal.",
        "target": "Dei to verdiane må vere like."
    },
    {
        "@id": "32",
        "source": "The file is too large. Allowed maximum size is %%limit%% %%suffix%%.",
        "target": "Fila er for stor. Den maksimale storleiken er %%limit%% %%suffix%%."
    },
    {
        "@id": "33",
    ...
    },
    {
        ...
        "target": "Fila kunne ikkje bli lasta opp."
    },
    {
        "@id": "35",
        "source": "This value should be a valid number.",
        "target": "Verdien må vere eit gyldig tal."
    },
    {
        "@id": "36",
        "source": "This file is not a valid image.",
        "target": "Fila er ikkje eit gyldig bilete."
    },
    {
        "@id": "37",
        "source": "This is not a valid IP address.",
        "target": "Dette er ikkje ei gyldig IP-adresse."
    },
    {
        "@id": "38",
        "source": "This value is not a valid language.",
        "target": "Verdien er ikkje eit gyldig språk."
    },
    {
        "@id": "39",
        "source": "This value is not a valid locale.",
        "target": "Verdien er ikkje ein gyldig lokalitet (språk/region)."
    },
    {
        "@id": "40",
        "source": "This value is not a valid country.",
        "target": "Verdien er ikkje eit gyldig land."
    },
    {
        "@id": "41",
        "source": "This value is already used.",
        "target": "Verdien er allereie i bruk."
    },
    {
        "@id": "42",
        "source": "The size of the image could not be detected.",
        "target": "Storleiken på biletet kunne ikkje oppdagast."
    },
    {
        "@id": "43",
        "source": "The image width is too big (%%width%%px). Allowed maximum width is %%max_width%%px.",
        "target": "Biletbreidda er for stor, (%%width%% pikslar). Tillaten maksimumsbreidde er %%max_width%% pikslar."
    },
    {
        "@id": "44",
        "source": "The image width is too small (%%width%%px). Minimum width expected is %%min_width%%px.",
        "target": "Biletbreidda er for liten, (%%width%% pikslar). Forventa minimumsbreidde er %%min_width%% pikslar."
    },
    {
        "@id": "45",
        "source": "The image height is too big (%%height%%px). Allowed maximum height is %%max_height%%px.",
        "target": "Bilethøgda er for stor, (%%height%% pikslar). Tillaten maksimumshøgde er %%max_height%% pikslar."
    },
    {
        "@id": "46",
        "source": "The image height is too small (%%height%%px). Minimum height expected is %%min_height%%px.",
        "target": "Billethøgda er for låg, (%%height%% pikslar). Forventa minimumshøgde er %%min_height%% pikslar."
    },
    {
        "@id": "47",
        "source": "This value should be the user's current password.",
        "target": "Verdien må vere brukaren sitt noverande passord."
    },
    {
        "@id": "48",
        "source": "This value should have exactly %%limit%% character.|This value should have exactly %%limit%% characters.",
        "target": "Verdien må vere nøyaktig %%limit%% teikn."
    },
    {
        "@id": "49",
        "source": "The file was only partially uploaded.",
        "target": "Fila vart berre delvis lasta opp."
    },
    {
        "@id": "50",
        "source": "No file was uploaded.",
        "target": "Inga fil vart lasta opp."
    },
    {
        "@id": "51",
        "source": "No temporary folder was configured in php.ini.",
        "target": "Førebels mappe (tmp) er ikkje konfigurert i php.ini."
    },
    {
        "@id": "52",
        "source": "Cannot write temporary file to disk.",
        "target": "Kan ikkje skrive førebels fil til disk."
    },
    {
        "@id": "53",
        "source": "A PHP extension caused the upload to fail.",
        "target": "Ei PHP-udviding forårsaka feil under opplasting."
    },
    {
        "@id": "54",
        "source": "This collection should contain %%limit%% element or more.|This collection should contain %%limit%% elements or more.",
        "target": "Denne samlinga må innehalde %%limit%% element eller meir.|Denne samlinga må innehalde %%limit%% element eller meir."
    },
    {
        "@id": "55",
        "source": "This collection should contain %%limit%% element or less.|This collection should contain %%limit%% elements or less.",
        "target": "Denne samlinga må innehalde %%limit%% element eller færre.|Denne samlinga må innehalde %%limit%% element eller færre."
    },
    {
        "@id": "56",
        "source": "This collection should contain exactly %%limit%% element.|This collection should contain exactly %%limit%% elements.",
        "target": "Denne samlinga må innehalde nøyaktig %%limit%% element.|Denne samlinga må innehalde nøyaktig %%limit%% element."
    },
    {
        "@id": "57",
